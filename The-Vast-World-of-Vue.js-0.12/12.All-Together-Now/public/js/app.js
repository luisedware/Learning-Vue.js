...
},{"./views/about":30,"./views/checkout":31,"vue":26,"vue-resource":15}],28:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    methods: {
        validate: function validate() {
            this.$http.get('/api/coupons/' + this.coupon.code).then(function (coupon) {
                this.coupon = coupon;
                this.valid = true;
...
},{"./coupon.template.html":29}],29:[function(require,module,exports){
module.exports = '<input type="text" name="coupon" id="coupon" class="form-control" v-model="coupon.code" v-on:blur="validate">\n\n<p class="label label-primary" v-text="coupon.description"></p>';
...
},{"../components/coupon":28,"./checkout.template.html":32}],32:[function(require,module,exports){
